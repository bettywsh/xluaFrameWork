...
public static class ShaderVariantCollector
{
	...
	/// 开始收集
	/// </summary>
	public static void Collector(string savePath, List<string> allMaterials, Action completedCallback = null)
	{
        ...
        string destDirectory = Path.GetDirectoryName(savePath);
        PackFile.CreateDirectory(destDirectory);
    ...
    private static void EditorUpdate()
	{
		...
		if (_steps == ESteps.WaitingDone)
		{
			...
			if (_elapsedTime.ElapsedMilliseconds > WaitMilliseconds)
			{
				...
				// 保存结果并创建清单
				EditorTools.SaveCurrentShaderVariantCollection(_savePath);
				//CreateManifest();
