  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 2: {
        ...
        msg->set_enum_value(static_cast<::unittest_drop_unknown_fields::Foo_NestedEnum>(val));
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        break;
      }
      default: {
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 2: {
        if (static_cast<::google::protobuf::uint8>(tag) != 16) goto handle_unusual;
        ::google::protobuf::uint64 val = ::google::protobuf::internal::ReadVarint(&ptr);
        msg->set_enum_value(static_cast<::unittest_drop_unknown_fields::FooWithExtraFields_NestedEnum>(val));
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        break;
      }
      ...
      case 3: {
        ...
        msg->set_extra_int32_value(::google::protobuf::internal::ReadVarint(&ptr));
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        break;
      }
      default: {
